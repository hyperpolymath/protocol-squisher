...
# TLC run script for SchemaAnalysis — generated by tlaiser
...
echo "Running TLC on SchemaAnalysis.tla ..."
java -XX:+UseParallelGC -Xmx4g -jar "$TLA2TOOLS" -workers 4 -config SchemaAnalysis.cfg SchemaAnalysis.tla
