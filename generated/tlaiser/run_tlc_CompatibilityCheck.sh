...
# TLC run script for CompatibilityCheck — generated by tlaiser
...
echo "Running TLC on CompatibilityCheck.tla ..."
java -XX:+UseParallelGC -Xmx4g -jar "$TLA2TOOLS" -workers 4 -config CompatibilityCheck.cfg CompatibilityCheck.tla
