...
mod tests {
    ...
    fn test_protobuf_bytes_to_vec_u8() {
        ...
        let bytes_as_vec = IrType::Container(protocol_squisher_ir::ContainerType::Vec(Box::new(
            IrType::Primitive(IrPrim::U8),
        )));
        let vec_u8 = IrType::Container(protocol_squisher_ir::ContainerType::Vec(Box::new(
            IrType::Primitive(IrPrim::U8),
        )));
