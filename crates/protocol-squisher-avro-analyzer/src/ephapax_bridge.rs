...
//!
//! This module converts Avro types analyzed from .avsc files into ephapax IR types
...
mod tests {
    ...
    #[test]
    fn test_avro_union_analysis() {
        // Avro unions with null create optional fields
        use protocol_squisher_ir::ContainerType;

        let ctx = IRContext::new();
        let optional_string = IrType::Container(ContainerType::Option(Box::new(
