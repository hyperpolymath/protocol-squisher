...
//!
//! This module converts ReScript types analyzed from .res files into ephapax IR types
...
mod tests {
    ...
    #[test]
    fn test_rescript_string_to_string() {
        let ctx = IRContext::new();
        let string_type = IrType::Primitive(IrPrim::String);
    ...
    #[test]
    fn test_rescript_option_to_option() {
        use protocol_squisher_ir::ContainerType;

        let ctx = IRContext::new();
        let option_type = IrType::Container(ContainerType::Option(Box::new(
    ...
    #[test]
    fn test_rescript_tuple_to_tuple() {
        use protocol_squisher_ir::ContainerType;

        let ctx = IRContext::new();
        let tuple_type = IrType::Container(ContainerType::Tuple(vec![
    ...
    #[test]
    fn test_rescript_js_dict_to_map() {
        use protocol_squisher_ir::ContainerType;

        let ctx = IRContext::new();
        let js_dict = IrType::Container(ContainerType::Map(
    ...
    #[test]
    fn test_tuple_different_length() {
        use protocol_squisher_ir::ContainerType;
    ...
    fn test_nested_containers() {
        ...
        let ctx = IRContext::new();
        let nested = IrType::Container(ContainerType::Option(Box::new(
