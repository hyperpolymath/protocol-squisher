...
[source,bash]
----
$ protocol-squish check --rust src/lib.rs --python models.py
...
[source,bash]
----
$ protocol-squish analyze --rust src/lib.rs --python models.py
...
[source,bash]
----
$ protocol-squish optimize --rust src/lib.rs --python models.py
...
[source,bash]
----
$ protocol-squish generate --rust lib.rs --python models.py
...
[source,bash]
----
$ protocol-squish optimize --rust lib.rs --python models.py

# Read suggestions, apply fixes, verify
$ protocol-squish check --rust lib.rs --python models.py
# Production ready: YES ✓
----
...
# Fail CI if production readiness < 90%
$ protocol-squish check --rust src/lib.rs --python models.py --min-quality 90
----
...
protocol-squish check --rust src/lib.rs --python models.py --min-quality 90
if [ $? -ne 0 ]; then
    echo "⚠ Schema quality below 90% - run 'protocol-squish optimize'"
    exit 1
fi
----
...
[source,bash]
----
$ protocol-squish analyze --rust lib.rs --python models.py --field my_field
