...
// Replace protocol-squisher, Protocol Squisher — See README.adoc for details., just run, Protocol Squisher started successfully. with actuals
= protocol-squisher — Quick Start for Users
:toc:
:toclevels: 2

== What is protocol-squisher?

Protocol Squisher — See README.adoc for details.
...
[source,bash]
----
just install --portable --prefix=./protocol-squisher-portable
----
...
[source]
----
Protocol Squisher started successfully.
----
...
* **Wiki**: https://github.com/hyperpolymath/protocol-squisher/wiki
