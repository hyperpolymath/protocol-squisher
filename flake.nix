{
  description = "protocol-squisher - {project-description}";
    ...
    flake-utils.lib.eachDefaultSystem (system:
      ...
      in
      {
        ...
        devShells.default = pkgs.mkShell {
          ...
          shellHook = ''
            echo "🚀 protocol-squisher development environment"
            echo "Language: rust"
            echo ""
        ...
        packages.default = pkgs.stdenv.mkDerivation {
          ...
          buildPhase = ''
            ...
            # For Ada: gprbuild -P protocol-squisher.gpr -XMODE=release
          '';

          installPhase = ''
            mkdir -p $out/bin
            # *REMINDER: Add install commands*
            # cp target/release/protocol-squisher $out/bin/  # Rust
            # cp bin/protocol-squisher $out/bin/  # Ada
          '';
        ...
        apps.default = {
          type = "app";
          program = "${self.packages.${system}.default}/bin/protocol-squisher";
        };
        ...
        checks = {
          ...
          test = pkgs.runCommand "test-protocol-squisher" {
